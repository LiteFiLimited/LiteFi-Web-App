...
export const userApi = {
  ...
  updateProfile: async (profileData: {
    ...
    return await apiRequest<ApiResponse<UserData>>(
      "patch",
      "/users/profile",
      profileData
    );
  ...
  getBankAccounts: async () => {
    return await apiRequest<ApiResponse<BankAccount[]>>(
      "get",
      "/users/bank-accounts"
    );
  },
  ...
  deleteBankAccount: async (accountId: string) => {
    return await apiRequest<ApiResponse<{ success: boolean }>>(
      "delete",
  ...
  setupTransactionPin: async (pinData: { pin: string }) => {
    return await apiRequest<ApiResponse<{ success: boolean }>>(
      "post",
      "/users/setup-transaction-pin",
      pinData
    );
  },

  verifyTransactionPin: async (pinData: { pin: string }) => {
    return await apiRequest<ApiResponse<{ verified: boolean }>>(
      "post",
      "/users/verify-transaction-pin",
      pinData
    );
  },
};
