...
export default function WithdrawModal({ amount, onClose }: WithdrawModalProps) {
        ...
        <div className="bg-white w-full max-w-md p-8 z-10 relative mx-4">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm mb-6">
              Provide your account details below to receive the funds
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-left">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="accountNumber" className="block text-sm mb-1">Account Number</label>
                  <Input
                    id="accountNumber"
                    value={accountNumber}
              ...
              <div className="text-xs text-gray-600 mt-4 mb-4">
                Account name must be the same as the one on your profile. We will follow up with you regarding the funding of the account.
              </div>
